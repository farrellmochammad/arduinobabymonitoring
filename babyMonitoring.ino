...
// MQTT Define
 const char* mqttServerIP = "192.168.43.114";E
...
void loop() {
  ...
  int param1 = sensorSuara();
  int param2 = sensorGetar();
  
  dataKirim = String(param1) + "," + String(param2);
  publishMQTT(device1, dataKirim);
  delay(100);
...
int sensorSuara(){
  ...
  int voiceCalib = map(voiceSensor,41,60,0,100);
